            ...
            case 0xB0:
                switch (data1) {
                    ...
                    case 0x43:  // soft pedal
                        ...
                        // parabolic curve starting at 161.29 (position 0)
                        // down to 0.0 (position 127).
...
juce::AudioProcessorValueTreeState::ParameterLayout MDAPianoAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Envelope Decay", 1),
        "Envelope Decay",
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Envelope Release", 1),
        "Envelope Release",
        juce::NormalisableRange<float>(0.0f, 100.0f, 1.0f),
        50.0f,
        juce::AudioParameterFloatAttributes().withLabel("%")));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Hardness Offset", 1),
        "Hardness Offset",
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Velocity to Hardness", 1),
        "Velocity to Hardness",
        juce::NormalisableRange<float>(0.0f, 100.0f, 1.0f),
        50.0f,
        juce::AudioParameterFloatAttributes().withLabel("%")));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Muffling Filter", 1),
        "Muffling Filter",
        juce::NormalisableRange<float>(0.0f, 100.0f, 1.0f),
        0.0f,
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Velocity to Muffling", 1),
        "Velocity to Muffling",
        juce::NormalisableRange<float>(0.0f, 100.0f, 1.0f),
        50.0f,
        juce::AudioParameterFloatAttributes().withLabel("%")));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Velocity Sensitivity", 1),
        "Velocity Sensitivity",
        juce::NormalisableRange<float>(0.0f, 100.0f, 1.0f),
        33.0f,
        juce::AudioParameterFloatAttributes().withLabel("%")));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Stereo Width", 1),
        "Stereo Width",
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Fine Tuning", 1),
        "Fine Tuning",
        juce::NormalisableRange<float>(-50.0f, 50.0f, 0.1f),
        0.0f,
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Random Detuning", 1),
        "Random Detuning",
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("Stretch Tuning", 1),
        "Stretch Tuning",
        juce::NormalisableRange<float>(-50.0f, 50.0f, 0.1f),
        0.0f,
        juce::AudioParameterFloatAttributes().withLabel("cents")));
